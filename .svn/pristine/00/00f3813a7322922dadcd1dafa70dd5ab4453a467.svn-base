		...
		<header id="header">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="${APP_PATH}/ftl/login.do" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
			...
			<nav>
				...
				<ul>
					...
					<li>
						...
						<ul>
							<li>
								<a href="${APP_PATH}/system/user/index.htm">用户维护</a>
							</li>
							<li>
								<a href="${APP_PATH}/system/role/index.htm">角色维护</a>
							</li>
							<li>
								<a href="${APP_PATH}/system/permission/index.htm">许可维护</a>
							</li>
						</ul>
					</li>
				</ul>
